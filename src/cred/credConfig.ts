...
export const credConfig: { [key: number]: CredConfig } = {
  ...
  27: {
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0x36864DB0396B1aC36c5d6609deD5Cc7F8073d08c',
    methodId: ['0xbc6efe31', '0xbc6efe31'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
      txs.filter((tx) => tx.from.toLowerCase() === address.toLowerCase()).length,
    project: 'Dolomite',
    tags: ['Defi', 'Lend', 'Dolomite'],
    relatedLinks: ['https://app.dolomite.io/balances'],
  },
  28: {
    ...baseSettings,
    title: 'Beradelic',
  ...
  33: {
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xCD2f8bdC75ACe031B50Ad7f0aeAA430aEd1F39F1',
    methodId: ['0x44b27a13'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
      txs.filter((tx) => tx.from.toLowerCase() === address.toLowerCase()).length,
    project: 'BEAR ARENA',
    tags: ['GameFI', 'BEAR ARENA'],
    relatedLinks: ['https://play.beararena.com/', 'https://x.com/beararenagame'],
  },
  34: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    from: '0x14C1D8b26F0eD831941616fC5AfdF052f74Ef0B0',
    contractAddress: 'any',
    methodId: 'any',
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    ...
    project: 'Berabot',
    tags: ['Berabot'],
    relatedLinks: ['https://t.me/Berabot_buybot'],
  },
  35: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0x1C66ae94C7dD18935F1E723d6395dAC27905Ab0c',
    methodId: '0x59968288',
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
      txs.filter((tx) => tx.from.toLowerCase() === address.toLowerCase()).length,
    project: 'OVERLAY PROTOCOL',
    tags: ['OVERLAY PROTOCOL', 'DeFi'],
    relatedLinks: ['https://app.overlay.market/', 'https://x.com/OverlayProtocol'],
  },
  36: {
    ...baseSettings,
    title: 'Smilee Beras',
    requirement: 'Own at least one Smilee Beras Token',
    credType: 'ADVANCED',
    network: 42161,
    verificationType: 'SIGNATURE',
    apiChoice: 'contractCall',
    apiKeyOrUrl: '',
    contractAddress: '0x136798606E85fb4086001AB065e5298fa0c37904',
    functionName: 'balanceOf',
    abi: [
      {
        name: 'balanceOf',
    ...
    relatedLinks: [
      ...
      'https://opensea.io/collection/smilee-beras',
      'https://arbiscan.io/address/0x136798606E85fb4086001AB065e5298fa0c37904',
    ],
  },
  37: {
    ...baseSettings,
    title: 'Holistic Bera',
    requirement: 'Own at least one Holistic Bera Token',
    credType: 'ADVANCED',
    network: 42161,
    verificationType: 'SIGNATURE',
    apiChoice: 'contractCall',
    apiKeyOrUrl: '',
    contractAddress: '0x75D94aa8Ab3E433e2083E20023F51603028493a5',
    functionName: 'balanceOf',
    abi: [
      {
        name: 'balanceOf',
    ...
    contractCallCondition: (result: number) => result > 0,
    args: async (address: Address) => [address],
    project: 'Holistic Bera',
    tags: ['Token', 'Holistic Bera', 'NFT'],
    relatedLinks: [
      'https://x.com/holisticbera',
      'https://opensea.io/collection/npc-beras-4',
      'https://arbiscan.io//address/0x75d94aa8ab3e433e2083e20023f51603028493a5',
    ],
  },
  38: {
    ...baseSettings,
    ...
    transactionCountCondition: (txs: any[], address: string): number => {
      const isContractDeployment = (tx: any): boolean => {
        const isFromAddress = tx.from.toLowerCase() === address.toLowerCase();
        const isSuccessful = !tx.isError || tx.isError === '0';
        const hasValidInput = tx.input && tx.input.length > 2;

        // Standard deployment (to address is null or undefined)
        const isStandardDeployment = (tx.to === null || tx.to === undefined) && hasValidInput;

        // Factory contract deployment (to address exists but input contains deployment bytecode)
        const isFactoryDeployment = tx.to !== null && tx.to !== undefined && hasValidInput;

        // Check for deployment bytecode patterns
        const deploymentPatterns = ['0x60806040', '0x60c06040', '0x60a06040'];
        const hasDeploymentPattern = deploymentPatterns.some((pattern) =>
          tx.methodId.toLowerCase().startsWith(pattern),
        );

        return isFromAddress && isSuccessful && (isStandardDeployment || isFactoryDeployment) && hasDeploymentPattern;
      };

      const contractDeployments = txs.filter(isContractDeployment);

      return contractDeployments.length;
    },
    project: 'Bera',
    tags: ['Developer', 'Bera'],
    relatedLinks: ['https://docs.berachain.com/developers/'],
  },
  39: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xE40Bb8EEeC72be2AB7731eF8E5446c30047A3a20',
    methodId: ['0x5b1b9c71'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'Phi',
    tags: ['GameFI', 'Phi'],
    relatedLinks: ['https://berachain-bartio.terminal.phi.box/', 'https://testnet.phi.box/'],
  },
  40: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xdb0b8257CDF984D25f3446252e86C1163BaBE3DD',
    methodId: ['0x0e34ac9b'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'Sudoswap',
    tags: ['NFT', 'Sudoswap'],
    relatedLinks: ['https://sudoswap.xyz/#/'],
  },
  41: {
    ...baseSettings,
    title: 'BongBears Family',
    requirement: 'Own at least one BongBearsDeployer Token',
    credType: 'ADVANCED',
    network: 1,
    verificationType: 'SIGNATURE',
    apiChoice: 'nftbalance',
    ...
    checkCondition: (result: number) => result > 0,
    project: 'bongbears',
    tags: ['Token', 'bongbears', 'NFT'],
    relatedLinks: [
      'https://opensea.io/collection/bongbears',
      'https://opensea.io/collection/bond-bears',
      'https://opensea.io/collection/berachain-bit-bears',
      'https://opensea.io/collection/boo-bears',
      'https://opensea.io/collection/the-baby-bears',
      'https://opensea.io/collection/the-band-bears',
    ],
  },
  42: {
    ...baseSettings,
    ...
    apiChoice: 'contractCall',
    apiKeyOrUrl: '',
    contractAddress: '0x762ad02a981562a591314d7a8a06ced6be6ae271',
    functionName: 'balanceOf',
    abi: [
      {
        name: 'balanceOf',
    ...
    args: async (address: Address) => [address],
    project: 'Wagmibera',
    tags: ['Token', 'Wagmibera', 'NFT'],
    relatedLinks: [
      'https://x.com/Wagmipad',
      'https://www.kingdomly.app/wagmibera',
      'https://arbiscan.io//address/0x762ad02a981562a591314d7a8a06ced6be6ae271',
      'https://wagmipad.org/',
    ],
  },
  43: {
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xB42FA579B971FCa501E320d7531C0d6b0FE95820',
    methodId: ['0xfaa9bce9'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
      txs.filter((tx) => tx.from.toLowerCase() === address.toLowerCase()).length,
    project: 'DiracFinance',
    tags: ['DeFi', 'DiracFinance'],
    relatedLinks: ['https://x.com/DiracFinance', 'https://bartio.dirac.finance/'],
  },
  44: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0x5b933d63648601268E231b1f558D1371021b0cdD',
    methodId: ['0xa0712d68'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'NATIVE',
    tags: ['DeFi', 'NATIVE'],
    relatedLinks: ['https://x.com/native_fi', 'https://native.org/app/credit-pool/?chainId=80084'],
  },
  45: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0x642a787392380BB7118c32CB1cB49E9005600cd9',
    methodId: ['any'],
    filterFunction: txFilter_Any,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'Stryke',
    tags: ['DeFi', 'Stryke'],
    relatedLinks: ['https://x.com/stryke_xyz', 'https://berachain-testnet.stryke.xyz/en/trade'],
  },
  46: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xe8361788d71675F20e8154aB927521e447EB9E5c',
    methodId: ['0x7da0b1fa'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'ROOTS',
    tags: ['DeFi', 'ROOTS'],
    relatedLinks: ['https://rootsfi.com/', 'https://x.com/rootsfi'],
  },
  47: {
    ...baseSettings,
    ...
    apiChoice: 'balanceCheck',
    apiKeyOrUrl: '',
    contractAddress: '0xA8fF751D316344e1336cF7875BB881DdD16e4F5B',
    checkCondition: (result: number) => result > 0,
    project: 'FORESTBEAR',
    tags: ['GameFi', 'FORESTBEAR', 'HYT'],
    relatedLinks: ['https://x.com/ForestBear_io'],
  },
  48: {
    ...baseSettings,
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0xf180136DdC9e4F8c9b5A9FE59e2b1f07265C5D4D',
    methodId: ['0x3a99d4eb'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
      txs.filter((tx) => tx.from.toLowerCase() === address.toLowerCase()).length,
    project: 'ZNS HONEY',
    tags: ['ZNS HONEY', 'Name Service'],
    relatedLinks: ['https://zns.bio/search?network=testnet&chain=80084', 'https://x.com/HoneyZns'],
  },
  49: {
    ...baseSettings,
    title: 'DEPOSIT ZERU',
    ...
    apiChoice: 'etherscan',
    apiKeyOrUrl: process.env.ROUTESCAN_API_KEY ?? '',
    contractAddress: '0x61dF6c455f1119d174F46B41a4BF39ac9Dedb4e4',
    methodId: ['0xe8eda9df'],
    filterFunction: txFilter_Standard,
    mintEligibility: (result: number) => result > 0,
    transactionCountCondition: (txs: any[], address: string) =>
    ...
    project: 'ZERU',
    tags: ['ZERU'],
    relatedLinks: ['https://testnet.zeru.finance/v1/Markets', 'https://x.com/zerufinance'],
  },
  50: {
    ...baseSettings,
    title: 'Chrono-Wizard Bear',
    requirement: 'Own at least one Chrono-Wizard Bear Token',
    credType: 'ADVANCED',
    network: 42161,
    verificationType: 'SIGNATURE',
    apiChoice: 'contractCall',
    apiKeyOrUrl: '',
    contractAddress: '0x3e27Dc6c103644E3df51BcfeFff40AFef137e277',
    functionName: 'balanceOf',
    abi: [
      {
        name: 'balanceOf',
    ...
    project: 'Wizzwoods',
    tags: ['Wizzwoods'],
    relatedLinks: ['https://opensea.io/collection/chrono-wizard-bear', 'https://x.com/Wizzwoods_game'],
  },
  51: {
    ...baseSettings,
    title: 'BERAUTISTICS',
    requirement: 'Own at least one BERAUTISTICS Token',
    credType: 'ADVANCED',
    network: 42161,
    verificationType: 'SIGNATURE',
    apiChoice: 'contractCall',
    apiKeyOrUrl: '',
    contractAddress: '0x3F979DDe509D2aedC99E9159f40e0D0D3E9DdB56',
    functionName: 'balanceOf',
    abi: [
      {
        name: 'balanceOf',
    ...
    contractCallCondition: (result: number) => result > 0,
    args: async (address: Address) => [address],
    project: 'BERAUTISTICS',
    tags: ['BERAUTISTICS'],
    relatedLinks: ['https://opensea.io/collection/berautistics-1', 'https://x.com/Berautistics'],
  },
};
